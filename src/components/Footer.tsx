import mark from "../assets/logomark-bw-light.png"
...
const Footer = () => {
  return (
    <footer className="pv4 ph3 ph5-ns tc">
      ...
      <a className="link dim gray dib h2 w2 br-100 mr3 pa2 bg-near-white ba b--black-10" href="https://medium.com/flexport-design" title="">
        <svg viewBox="0 0 1151 1151" xmlns="http://www.w3.org/2000/svg" fillRule="evenodd" clipRule="evenodd" strokeLinejoin="round" strokeMiterlimit="2"><path d="M637.224 574.924c0 163.67-131.78 296.35-294.33 296.35-162.55 0-294.34-132.68-294.34-296.35 0-163.67 131.78-296.36 294.34-296.36 162.56 0 294.33 132.69 294.33 296.36M960.114 574.924c0 154.06-65.89 279-147.17 279-81.28 0-147.17-124.94-147.17-279s65.88-279 147.16-279 147.17 124.9 147.17 279M1092.184 574.924c0 138-23.17 249.94-51.76 249.94-28.59 0-51.75-111.91-51.75-249.94s23.17-249.94 51.75-249.94 51.76 111.9 51.76 249.94" fill-rule="nonzero"/><path d="M1387.544-1.336h-296.29v.25H50.064v-.25h-296.29v1150.07h119.51v.44h1410.41v-.44h103.85V-1.336zm-296.29 296.54v557.67H50.064v-557.67h1041.19z" fill="none"/></svg>
      </a>
      <a className="link dim gray dib br-100 h2 w2 mr3 pa2 bg-near-white ba b--black-10" href="https://www.linkedin.com/company/flexport" title="">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 260.366 260.366"><path d="M34.703.183C15.582.183.014 15.748 0 34.884 0 54.02 15.568 69.588 34.703 69.588c19.128 0 34.688-15.568 34.688-34.704C69.391 15.75 53.83.183 34.703.183zM60.748 83.531H8.654a4.488 4.488 0 00-4.488 4.489v167.675a4.488 4.488 0 004.488 4.488h52.093a4.49 4.49 0 004.489-4.488V88.02a4.486 4.486 0 00-4.488-4.489zM193.924 81.557c-19.064 0-35.817 5.805-46.04 15.271V88.02c0-2.48-2.01-4.489-4.489-4.489H93.424a4.489 4.489 0 00-4.489 4.489v167.675a4.488 4.488 0 004.489 4.488h52.044a4.49 4.49 0 004.489-4.488v-82.957c0-23.802 4.378-38.555 26.227-38.555 21.526.026 23.137 15.846 23.137 39.977v81.535a4.489 4.489 0 004.49 4.488h52.068a4.489 4.489 0 004.488-4.488v-91.977c-.001-38.253-7.553-82.161-66.443-82.161z"/></svg>
      </a>
      <a className="link dim gray dib br-100 h2 w2 mr3 pa2 bg-near-white ba b--black-10" href="https://dribbble.com/Flexport" title="">
